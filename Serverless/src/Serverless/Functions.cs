...
public class Functions
{
    ...
    [LambdaFunction(Policies = "AWSLambdaBasicExecutionRole", MemorySize = 256, Timeout = 30)]
    [RestApi(LambdaHttpMethod.Get, "/again")]
    public IHttpResult GetAgain(ILambdaContext context)
    {
        context.Logger.LogInformation("Handling the 'GetAgain' Request");

        return HttpResults.Ok("Hello Again AWS Serverless");
    }
}
